<template>
  <div class="wrap list_ys">
    ...
    <div class="details">
      ...
      <div>
        <p v-html="details_content">{{articles.task_desc}}</p>
...
.details div p{padding: 0.15625rem; text-align:justify; line-height: 1.5; font-size: 0.4375rem; min-height: 10.59375rem; color: #666666;}
